...
public class GameView {
    ...
    public void start(Stage stage) {
       ...
       // Group root = new Group();
        ...
        instructionsBtn.setFocusTraversable(false);
    ...
    private void update() {
        ...
        if (currentPiece.getY() <= 0) {
            setGameOver(true);   // ✅ triggers blackout sound + stops music + shows message
            return;
        }
...
public class GameView {
  ...
  + "diffuse_radiation,wind_speed_120m,wind_speed_80m,wind_speed_10m,"
  + "wind_gusts_10m,precipitation,is_day"
  + "&timezone=America/Barbados",
    ZoneId.of("America/Barbados")
);

weather.setUseLiveData(true);
weather.update();
